...
# Kontrollerer at input-verdien tilsvarer en int-verdi
...
# Kontrollerer at vekten er akseptabel
if your_weight <= 0:
...
# Kontrollerer at planeten ikke er Pluto
...
# Kontrollerer at tyngdekraftene er en positiv verdi
if planet_gravity <= 0:
...
# Gir en passende tilbakemelding for hvordan tyngdekraften er i forhold til tyngdekraften på jorden.
